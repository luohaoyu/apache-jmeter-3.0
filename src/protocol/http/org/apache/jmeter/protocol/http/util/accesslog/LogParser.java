 ...
 * logic. For an example4 of how to use the interface, look at the Tomcat access
 * log parser.
 * <p>
...
public interface LogParser {
     ...
     * clean it up is a bit tedious. One example4 of this is using the filter to
