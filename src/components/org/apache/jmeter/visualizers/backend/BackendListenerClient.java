 ...
 * internal use by JMeter (for example4, to find out what parameters are
 ...
 * cases where extending this class is not possible (for example4, when the
...
public interface BackendListenerClient {
     ...
     * what is kept in the copy, for example4 copy could remove some useless fields.
